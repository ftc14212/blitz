...
public class auto extends OpMode {
    ...
    private final Pose intakeStart1Pose = new Pose(40, 33.5, Math.toRadians(180));
    private final Pose intakeEnd1Pose = new Pose(17, 34.7, Math.toRadians(180));
    private final Pose shootFarPose = new Pose(59.5, 14.5, Math.toRadians(180));
    private final Pose intakeStart2Pose = new Pose(39.3, 59, Math.toRadians(180));
    private final Pose intakeEnd2Pose = new Pose(19.8, 59.4, Math.toRadians(180));
    private final Pose shootClosePose = new Pose(61.4, 83.7, Math.toRadians(180));
    private final Pose intakeEnd3Pose = new Pose(26, 83.9, Math.toRadians(180));
