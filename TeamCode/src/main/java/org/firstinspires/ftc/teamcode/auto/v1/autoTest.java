...
@Autonomous(name = "auto 123", group = ".ftc14212")
public class autoTest extends OpMode {
    ...
    private final Pose startPose = new Pose(56.5, 8.39, Math.toRadians(180));
    private final Pose intakeStart1Pose = new Pose(38.8, 34.7, Math.toRadians(180));
    private final Pose intakeEnd1Pose = new Pose(18, 34.7, Math.toRadians(180));
    private final Pose shootFarPose = new Pose(59.5, 14.5, Math.toRadians(180));
    private final Pose intakeStart2Pose = new Pose(39, 62.6, Math.toRadians(180));
    private final Pose intakeEnd2Pose = new Pose(19.8, 62.6, Math.toRadians(180));
    private final Pose shootClosePose = new Pose(61.4, 83.7, Math.toRadians(180));
    private final Pose intakeEnd3Pose = new Pose(22.6, 83.9, Math.toRadians(180));
    private final Pose parkPose = new Pose(48.9, 66.6, Math.toRadians(180));
        ...
        switch (pathState) {
            case 0:
                if (!intake1Started) {
                    ...
                    if (actionTimer.getElapsedTime() >= shooterT) {
