...
@Configurable
@Autonomous(name = "3 baller auto red", group = ".ftc14212")
public class autoSSRS extends OpMode {
    ...
    public static final Pose startPose = autoSS.startPose.mirror();
    public static final Pose parkPose = autoSS.parkPose.mirror();
